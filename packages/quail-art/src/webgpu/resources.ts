...
function hasGlobalDevice(
	deviceToCheck: GPUDevice | unknown = typeof device !== 'undefined' ? device : globalThis.device,
...
export function deviceOrThrow(fallback?: unknown): GPUDevice {
	const deviceToCheck: GPUDevice | unknown = typeof device !== 'undefined' ? device : globalThis.device;
