...
type TextureUse = 'diffuse' | 'normal' | 'depth';
type TextureSet<T extends TextureUse[]> = { [P in T[number]]: GPUTexture };
export class PassComposer<Textures extends TextureUse[]> {
  device: GPUDevice;
